...
/*
PIC32MX platform specific implementation routines (for Atmega8, rewrite for your MC)
*/
#define _PIC32MX_DEMO_VER "1.0"
...
int execute (int argc, const char * const * argv)
{
	...
	while (i < argc) {
		if (strcmp (argv[i], _CMD_HELP) == 0) {
			...
			print (" library PIC32MX DEMO v");
			print (_PIC32MX_DEMO_VER);
			print("\n\r");
